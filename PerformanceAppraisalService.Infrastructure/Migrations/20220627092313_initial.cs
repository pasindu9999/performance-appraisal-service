        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reviwers_Panels_PanelId",
                        column: x => x.PanelId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeId = table.Column<Guid>(nullable: false),
                    EmployeeFirstName = table.Column<string>(nullable: true),
                    pasheetId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reviwees_PAsheets_pasheetId",
                        column: x => x.pasheetId,
                        principalTable: "PAsheets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
